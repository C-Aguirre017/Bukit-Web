...
p = Pin.create!(user: Carlos, publication: Time.now, realization: nil, duration: 30, price: 5000, faculty: 'san joaquin', latitude: -33.498444, longitude: -70.611722, course: r)
